...
export function ArticleFloatingBar({ href }: { href: string; label: string }) {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-40 lg:hidden flex gap-2">
      <a
        ...
        className="flex items-center justify-center px-3 py-3 bg-white/95 backdrop-blur border border-border rounded-xl shadow-lg"
        style={{ textDecoration: "none" }}
      >
        <svg width="20" height="20" fill="#B87942" viewBox="0 0 24 24">
