        ...
        <div className="grid md:grid-cols-[1fr_auto] gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a
                href="https://www.instagram.com/doghub_hakone/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#8F7B65] hover:text-[#3C200F] transition-colors"
              ...
              <a
                href="https://www.facebook.com/doghubhakone"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#8F7B65] hover:text-[#3C200F] transition-colors"
                aria-label="Facebook"
