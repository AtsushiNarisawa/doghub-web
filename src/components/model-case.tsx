    ...
    days: [
      {
        ...
        steps: [
          ...
          { time: "15:00", place: "箱根神社", icon: "dog", withDog: true },
    ...
    days: [
      ...
      },
      {
        ...
        steps: [
          ...
          { time: "10:30", place: "ポーラ美術館", icon: "spot" },
          { time: "12:30", place: "そば処 九九でランチ", icon: "spot" },
          { time: "14:00", place: "DogHubお迎え", icon: "hub" },
          { time: "14:30", place: "仙石原ススキ草原を散歩", icon: "dog", withDog: true },
          { time: "16:00", place: "帰宅", icon: "car" },
        ],
      },
    ],
  },
