...
const points = [
  ...
  },
  {
    icon: "🌿",
    title: "毎日必ずドッグランへ",
    body: "お預かり中は必ず専用ドッグランにお出しします。屋根付きなので雨の日でも安心。お散歩は¥550/回のオプションでも承ります。",
  },
  {
    icon: "📍",
    title: "仙石原の好立地",
              ...
              <table className="w-full text-left border-collapse" style={{ fontSize: "15px" }}>
                <tbody className="text-[#3C200F]">
                  {[
                    ...
                    ["カフェ併設", "土日祝はお迎えの後、そのまま犬同伴OKのカフェでおむすび＆スープを。平日はお飲み物のテイクアウト販売のみとなります。"],
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <script
              ...
              dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                mainEntity: [
                  ...
                  { "@type": "Question", name: "当日の予約は可能ですか？", acceptedAnswer: { "@type": "Answer", text: "空きがあれば当日でも承っております。ただしWEB予約は翌日以降となりますので、当日ご利用をご希望の場合はお電話（0460-80-0290）でご相談ください。繁忙期（GW、夏休み、年末年始、紅葉シーズン）は満室になることが多いため、お早めのご予約をおすすめします。" }},
                ],
              }) }}
            />
            <div className="space-y-4">
              {[
                ...
                { q: "当日の予約は可能ですか？", a: "空きがあれば当日でも承っております。ただしWEB予約は翌日以降となりますので、当日ご利用をご希望の場合はお電話（0460-80-0290）でご相談ください。繁忙期（GW、夏休み、年末年始、紅葉シーズン）は満室になることが多いため、お早めのご予約をおすすめします。" },
              ].map((faq) => (
