            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  a: "DogHubではケージではなく壁に囲まれた個室でお預かりします。さらに、1日2回以上専用ドッグランで遊ぶ時間を設けており、閉じ込めっぱなしにはしません。",
                },
                {
                  q: "夜中に何かあったらどうするの",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                ...
                { num: "03", title: "運動・リフレッシュの機会", body: "お預かり中にドッグランや散歩の時間があるか確認を。DogHubは1日2回以上ドッグランで遊ばせます。" },
