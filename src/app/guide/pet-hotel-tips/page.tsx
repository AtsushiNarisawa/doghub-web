            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  a: "DogHubではケージではなく壁に囲まれた個室でお預かりします。さらに、お預かり中は必ず専用ドッグランにお出しするので、閉じ込めっぱなしにはしません。",
                },
                {
                  q: "夜中に何かあったらどうするの",
                  a: "24時間スタッフが常駐しています。夜間も宿直スタッフがおり、ライブカメラで随時見守っています。万が一の体調不良時は、飼い主様に緊急連絡いたします。また、車で4分の場所にあるアニマルクリニック仙石原と提携しており、クリニックの診療時間内であればご相談・受診いたします。夜間は診療時間外となるため、スタッフが見守りながら飼い主様と連絡を取り合って対応いたします。",
                },
                {
                  q: "ごはんを食べてくれるか心配",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                ...
                { num: "03", title: "運動・リフレッシュの機会", body: "お預かり中に運動の時間があるか確認を。DogHubはお預かり中、必ず専用ドッグランにお出しします（お散歩は宿泊のお預かりのみ¥550/回のオプション）。" },
                { num: "04", title: "緊急時の対応", body: "体調不良時の連絡体制と、近隣の動物病院との連携が整っているか。DogHubは車で4分のアニマルクリニック仙石原と提携しています。お預かり中に異変があった場合は、飼い主様にご連絡のうえ、クリニックの診療時間内であればご相談・受診いたします。診療時間外は24時間常駐のスタッフが見守りながら、飼い主様と連絡を取り合って対応します。" },
        ...
        <section className="py-16 px-6 bg-[#F7F7F7]">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                { title: "ワクチン接種を済ませる", body: "原則1年以内の混合ワクチンと狂犬病予防接種をお願いしています。接種後2週間は免疫が安定しないため、余裕をもって準備を。複数年有効なワクチンの場合や、獣医師の判断で接種が難しい場合は、ご予約時にお知らせください。" },
