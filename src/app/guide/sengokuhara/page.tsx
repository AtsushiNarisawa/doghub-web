...
const courses = [
  {
    ...
    distance: "約1.5km",
    level: "初心者向け",
    body: "仙石原を代表する絶景スポット。秋は一面の黄金色のすすきが広がります。遊歩道は比較的平坦で、小型犬でも歩きやすい。リード着用で散策OK。春〜夏は緑のすすきも美しい。DogHubから車で2分。",
  ...
  },
  {
    ...
    distance: "約1.5km",
    level: "初心者向け",
    body: "日本各地の湿地帯の植物約1,700種を集めた植物園。園内はリードでのお散歩はできませんが、抱っこ・キャリー・ペットカートなら入園OK（砂利・木道が多いのでカートが便利）。周辺の遊歩道はリードでお散歩でき、四季折々の花が楽しめます。DogHubから車で3分。",
    season: "3月14日〜11月30日（12月〜翌3月中旬は冬季休園）",
  },
  {
    name: "仙石原自然探勝歩道コース",
    time: "約60〜120分",
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { title: "リード必須", body: "ご紹介する散歩コースではリード着用が必要です（1m程度の短いリードがおすすめ。伸縮リードは他の歩行者の迷惑になります）。なお箱根湿生花園の園内のみ、リードで歩かせることはできず、抱っこ・キャリー・ペットカートでの入園となります。" },
