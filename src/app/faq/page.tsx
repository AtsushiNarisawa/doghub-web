...
const faqCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "箱根の美術館に犬は入れますか？",
        a: "箱根の主要美術館（ポーラ美術館、ガラスの森美術館、彫刻の森美術館、岡田美術館）はいずれもペット同伴不可です。庭園・敷地内を含めて犬連れではご入館いただけません（公式の方針は各館サイトでご確認ください）。芦ノ湖畔の成川美術館のみ、条件付きで小型犬の同伴入館が可能です。美術館を楽しみたい場合は、愛犬をペットホテルに預けるのが一般的です。DogHub箱根仙石原はポーラ美術館から車4分、ガラスの森美術館から車3分の立地です。",
      },
      {
