...
const faqCategories = [
  {
    ...
    items: [
      ...
      {
        q: "当日の持ち物は何が必要ですか？",
        a: "1年以内の混合ワクチン証明書、狂犬病予防接種証明書、普段食べているご飯、リード・首輪をお持ちください。お気に入りのおもちゃやブランケットもあると安心です。なお、複数年有効なワクチンを接種されている場合や、獣医師の判断で接種を見合わせている場合は、ご予約時にその旨をお知らせください。",
      },
      {
        q: "キャンセルはできますか？",
      ...
      {
        q: "定休日はいつですか？",
        a: "水曜・木曜が定休日です。ドッグホテルの営業時間は午前9時〜午後5時。カフェのおむすび＆スープは土曜・日曜・祝日の午前11時〜午後5時、それ以外の営業日はお飲み物のテイクアウト販売のみ（午前9時〜午後5時）となります。",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: "ワクチン未接種でも預けられますか？",
        a: "他のわんちゃんの安全のため、原則として1年以内の混合ワクチンと狂犬病予防接種をお願いしております。ただし、複数年有効なワクチンを接種されている場合や、獣医師の判断で接種を見合わせている場合は、ご予約フォームのワクチン接種状況でその旨をお選びいただけます（事情の記入欄もございます）。個別に確認のうえ対応いたしますので、まずはご相談ください。",
      },
      {
        q: "お預かり中に体調を崩したらどうなりますか？",
        a: "まず飼い主様へご連絡いたします。あわせて、DogHub箱根仙石原は車で4分の場所にあるアニマルクリニック仙石原（箱根町仙石原）と提携しており、クリニックの診療時間内であればご相談・受診いたします。夜間や診療時間外は24時間常駐のスタッフとライブカメラで見守りながら、飼い主様と連絡を取り合って対応いたします。24時間いつでも受診できる体制ではございませんので、あらかじめご了承ください。なお、受診や治療にかかる費用（診察料・お薬代など）は飼い主様のご負担となります。ご来店時にお渡しする同意書でもご確認いただいております。",
      },
      {
        q: "持病があるのですが預けられますか？",
  ...
  },
  {
    ...
    items: [
      {
        q: "料金プランを教えてください",
        a: "お預かりは3つのプランからお選びいただけます。半日お預かり（4時間）¥3,300、1日お預かり（8時間）¥5,500、宿泊お預かり（1泊）¥7,700〜。このほか1時間¥1,100のスポット利用もございます（オンライン予約では承っておりませんので、お電話でご相談ください）。料金はワンちゃん1頭あたりで、すべて税込です。2頭以上お預けの場合は頭数分となります（例：宿泊で2頭なら1泊¥15,400）。",
      },
      {
        q: "予定より延びてしまったときの料金は？",
        a: "営業時間内であれば、延びた1時間ごとにスポット利用料¥1,100を追加でいただきます。こちらもワンちゃん1頭あたりの料金です。例1：半日お預かり（4時間・¥3,300）で1時間延びた場合は¥4,400。例2：宿泊（¥7,700）でお迎えが1時間遅くなった場合は¥8,800。例3：2頭お預けで1時間延びた場合は¥1,100×2頭＝¥2,200の追加。お迎えが遅くなりそうなときは、わかった時点でお電話いただけると助かります。",
      },
      {
        q: "営業時間を過ぎてしまいそうなときは？",
        a: "お預かり・お引き取りの受付は17時までとさせていただいています。それ以降になりそうな場合は、必ず事前にお電話ください（0460-80-0290）。スタッフの体制により、お受けできない場合があります。時間外のご対応となった場合は、時間外料金として1時間あたり¥1,100を頂戴します。こちらはワンちゃんの頭数にかかわらず1組さまあたりの料金です（例：2頭お預けで1時間の時間外となった場合も¥1,100）。",
      },
      {
        q: "オプションサービスはありますか？",
        a: "お散歩オプション（¥550/回・宿泊のお預かりのみ）をご用意しています。また、ご飯やおやつ、マナーウェアなどの販売（¥220〜）もございますので、持ち物を忘れてしまった場合もご安心ください。",
      },
      {
        q: "支払い方法は？",
  ...
  },
  {
    ...
    items: [
      {
        q: "お部屋のサイズを教えてください",
        a: "2種類のサイズのお部屋がございます。ただし当日のご利用状況やわんちゃんの状態に応じてスタッフが調整させていただくため、お部屋をお選びいただくことはできません。サイズは、大きなお部屋が横幅130cm×高さ80cm×奥行き73cm、通常のお部屋が横幅85cm×高さ60cm×奥行き60cmです。",
      },
      {
        q: "ドッグランはありますか？",
        a: "はい、専用ドッグランを併設しています。屋根付きエリアもございますので、雨の日でもわんちゃんが外で遊べます。お預かり中は曜日を問わず、スタッフがドッグランでリフレッシュさせます。飼い主様がご一緒にお使いいただけるのは、おむすび＆スープをご提供する土曜・日曜・祝日にカフェをご利用の場合のみです（ドッグランだけのご利用、平日のご利用はできません）。",
      },
      {
        q: "預けている間の様子は確認できますか？",
      ...
      {
        q: "カフェも併設していると聞きましたが？",
        a: "はい、OMUSUBI & SOUP CAFEを併設しています。おむすび＆スープのご提供は土曜・日曜・祝日の午前11時〜午後5時で、この日は店内のイートインスペースでわんちゃんとご一緒にお過ごしいただけます。平日はお飲み物のテイクアウト販売のみ（午前9時〜午後5時）で、店内でのご飲食はできません。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "箱根仙石原にDogHub箱根仙石原があります。半日（4時間）¥3,300〜、1日（8時間）¥5,500、宿泊1泊¥7,700〜で犬を預けられます。ポーラ美術館から車4分、ガラスの森美術館から車3分の立地で、美術館巡りやユネッサン、ゴルフの間に愛犬を預けるお客さまが多いです。24時間スタッフ常駐・完全個室・ドッグラン併設。体重15kgまでの小型犬・中型犬が対象です。",
      },
      {
        q: "箱根で犬と泊まれる宿はありますか？",
      ...
      },
      {
        ...
        a: "箱根でテラス席なら犬OKのお店はいくつかありますが、室内で犬と一緒に食事できるお店は非常に限られています。DogHub箱根仙石原に併設のOMUSUBI & SOUP CAFEは室内犬同伴OK・予約不要・頭数制限なしで利用できます。おむすび（¥280〜）とスープ（¥400〜）がメニューの中心で、ご利用のお客様は併設ドッグランで食後にわんちゃんを遊ばせることもできます。おむすび＆スープのご提供は土曜・日曜・祝日の11:00〜17:00です（平日はお飲み物のテイクアウト販売のみ・9:00〜17:00で、店内でのご飲食とドッグランのご利用はできません）。水曜・木曜定休。",
      },
      {
        q: "ユネッサンに犬は連れて行けますか？",
      ...
      {
        q: "箱根の美術館に犬は入れますか？",
        a: "箱根の主要美術館（ポーラ美術館、ガラスの森美術館、彫刻の森美術館、岡田美術館）は、いずれも展示館内へのペット同伴はできません。ガラスの森・彫刻の森・岡田は庭園・敷地内を含めて犬連れではご入館いただけません。ポーラ美術館は、建物を囲む屋外の森の遊歩道（無料・約1km）のみ、リードを短く持てば愛犬と散策できます。芦ノ湖畔の成川美術館は、小型犬を抱っこ・キャリー・ペットカートに乗せれば（足を床につけない状態で）同伴入館できます。展示をゆっくり楽しみたい場合は、愛犬をペットホテルに預けるのが一般的です。DogHub箱根仙石原はポーラ美術館から車4分、ガラスの森美術館から車3分の立地です。（最新の方針は各館公式サイトでご確認ください）",
      },
      {
