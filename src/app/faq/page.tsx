...
const faqCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "箱根の美術館に犬は入れますか？",
        a: "箱根の主要美術館（ポーラ美術館、ガラスの森美術館、彫刻の森美術館、岡田美術館）は全て犬の館内入場はNGです。ポーラ美術館の森の遊歩道やガラスの森美術館の庭園は犬連れで散策できますが、展示エリアには入れません。美術館巡りをしたい場合は、愛犬をペットホテルに預けるのが一般的です。DogHub箱根仙石原はポーラ美術館から車4分、ガラスの森美術館から車3分の立地です。",
      },
      {
