...
const faqCategories = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "水曜・木曜が定休日です。ドッグホテルの営業時間は午前9時〜午後5時。カフェのおむすび＆スープは土曜・日曜・祝日の午前11時〜午後5時、それ以外の営業日はお飲み物のみ（午前9時〜午後5時）のご提供です。なお、お盆期間の8月12日（水）・13日（木）は営業いたしますが、8月12日〜14日のカフェはお飲み物のみとなります。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "箱根でテラス席なら犬OKのお店はいくつかありますが、室内で犬と一緒に食事できるお店は非常に限られています。DogHub箱根仙石原に併設のOMUSUBI & SOUP CAFEは室内犬同伴OK・予約不要・頭数制限なしで利用できます。おむすび（¥280〜）とスープ（¥400〜）がメニューの中心で、ドッグラン併設なので食後にわんちゃんを遊ばせることもできます。おむすび＆スープのご提供は土曜・日曜・祝日の11:00〜17:00です（それ以外の営業日はお飲み物のみ・9:00〜17:00）。水曜・木曜定休。",
      },
      {
        q: "ユネッサンに犬は連れて行けますか？",
