...
const faqCategories = [
  {
    ...
    items: [
      ...
      {
        q: "定休日はいつですか？",
        // お盆の臨時営業（2026年8月12日・13日）を追記中。お盆明けの 2026-08-14 以降に該当の一文を削除すること
        a: "水曜・木曜が定休日です。ドッグホテルの営業時間は午前9時〜午後5時。カフェのおむすび＆スープは土曜・日曜・祝日の午前11時〜午後5時、それ以外の営業日はお飲み物のテイクアウト販売のみ（午前9時〜午後5時）となります。なお、お盆期間の8月12日（水）・13日（木）は営業いたしますが、8月12日〜14日のカフェはお飲み物のみとなります。",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "まず飼い主様へご連絡いたします。あわせて、DogHub箱根仙石原は車で4分の場所にあるアニマルクリニック仙石原（箱根町仙石原）と提携しており、クリニックの診療時間内であればご相談・受診いたします。夜間や診療時間外は24時間常駐のスタッフとライブカメラで見守りながら、飼い主様と連絡を取り合って対応いたします。24時間いつでも受診できる体制ではございませんので、あらかじめご了承ください。",
      },
      {
        q: "持病があるのですが預けられますか？",
