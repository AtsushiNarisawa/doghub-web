...
export const metadata: Metadata = {
  title: "ペット可ホテル × 日中預かり｜チェックイン前・チェックアウト後の観光に｜DogHub箱根仙石原",
  description: "箱根のペット可宿泊施設に泊まる方へ。チェックイン前やチェックアウト後の観光中、愛犬をDogHubにお預け。半日4時間¥3,300〜。レジーナ仙石原など近隣施設からご案内多数。ドッグラン併設で愛犬ものびのび。",
