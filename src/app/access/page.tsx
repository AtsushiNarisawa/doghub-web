...
export const metadata: Metadata = {
  openGraph: {
    ...
    description: "DogHub箱根仙石原の店舗情報・アクセス。神奈川県足柄下郡箱根町仙石原928-15。ドッグホテル営業時間9時〜17時、カフェは土日祝11〜17時（平日はお飲み物のみ9時〜17時）、定休日水木。",
              ...
              <div>
                ...
                <div className="mt-8 space-y-2 text-[#3C200F]" style={{ fontSize: "18px", fontWeight: 400 }}>
                  ...
                  <div>
                    ...
                    <p>土日祝：午前11時〜午後5時（おむすび＆スープ）</p>
                    <p>平日：午前9時〜午後5時（お飲み物のみ）</p>
                  </div>
                  <p>定休日：水曜・木曜</p>
