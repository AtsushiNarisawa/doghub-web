...
export const metadata: Metadata = {
  openGraph: {
    ...
    description: "DogHub箱根仙石原の店舗情報・アクセス。神奈川県足柄下郡箱根町仙石原928-15。ドッグホテル営業時間9時〜17時、カフェは土日祝11〜17時（平日はお飲み物のテイクアウト販売のみ9時〜17時）、定休日水木。",
              ...
              <div>
                ...
                <div className="mt-8 space-y-2 text-[#3C200F]" style={{ fontSize: "18px", fontWeight: 400 }}>
                  ...
                  <div>
                    ...
                    <p>土日祝：午前11時〜午後5時（おむすび＆スープ・店内でお召し上がりいただけます）</p>
                    <p>平日：午前9時〜午後5時（お飲み物のテイクアウト販売のみ）</p>
                    <p style={{ fontSize: "16px" }}>※店内のご飲食と併設ドッグランのご利用は、土日祝にカフェをご利用のお客様に限ります</p>
                  </div>
                  <p>定休日：水曜・木曜</p>
                  {/* お盆の臨時営業（2026年8月12日・13日）。お盆明けの 2026-08-14 以降に削除すること */}
                  <p>※お盆期間の8月12日（水）・13日（木）は営業いたします（8月12日〜14日のカフェはお飲み物のみ）</p>
