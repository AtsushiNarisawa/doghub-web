...
const spots = [
  ...
  },
  {
    ...
    body: "ポーラ美術館は、神奈川県箱根町の国立公園内に位置する美術館です。約1万点の西洋絵画コレクションを有し、印象派から現代アートまでの作品を展示しています。企画展や常設展を開催し、アートを気軽に体験できる空間を提供しています。緑豊かな自然に囲まれた美術館では、絵画鑑賞と共に、カフェテラスからの景色を楽しめます。なお館内はペット同伴不可ですが、建物を囲む屋外の森の遊歩道（無料・約1km）はリードを短く持てば愛犬と散策できます。",
  ...
  },
  {
    ...
    body: "箱根湿生花園は、日本各地の湿地帯に生育する約1,700種もの植物を集めた植物園です。園内には、低地から高山まで、様々な湿地帯の植物が観察できます。湿原、川、湖沼などの水湿地に生育する植物を中心に、草原や林、高山の植物も楽しめます。四季折々の表情を見せる園内は、自然観察や写真撮影に最適で、箱根の自然を存分に堪能できます。愛犬は抱っこ・キャリー・ペットカートなら園内に入れます（木道・砂利道が多いのでカートが便利。リードで歩かせるのは不可）。",
