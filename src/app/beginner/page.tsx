...
const faqs = [
  ...
  { q: "営業時間は？", a: "ペットホテルは9:00〜17:00（早朝7時からの預かりも対応）。カフェのおむすび＆スープは土日祝の11:00〜17:00、それ以外の営業日はお飲み物のみ（9:00〜17:00）です。定休日は水曜・木曜です。なお、お盆期間の8月12日（水）・13日（木）は営業いたしますが、8月12日〜14日のカフェはお飲み物のみとなります。" },
];
