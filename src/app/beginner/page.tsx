...
const steps = [
  { num: "1", title: "ご予約", desc: "オンラインまたはお電話でご予約ください。WEB予約は翌日以降となりますので、当日ご利用をご希望の場合はお電話でご相談ください（空きがあれば承ります）。繁忙期は早めのご予約がおすすめです。" },
  { num: "2", title: "チェックイン", desc: "ご来店いただき、わんちゃんをお預けいただきます。体調やご飯の量、お散歩の希望などをスタッフにお伝えください。" },
  { num: "3", title: "お預かり中", desc: "個室でのんびり過ごし、お預かり中は必ず専用ドッグランにお出しします。看板犬との交流もご希望に応じて。" },
...
const faqs = [
  ...
  { q: "予防接種は必要ですか？", a: "原則として狂犬病予防接種証明書と混合ワクチン接種証明書（1年以内）をお願いしております。ご来店時にご提示ください。なお、複数年有効なワクチンを接種されている場合や、獣医師の判断で接種を見合わせている場合は、ご予約時にその旨をお知らせください。個別に対応いたします。" },
  { q: "何を持っていけばいいですか？", a: "予防接種証明書、リード、普段のフード（1食分ずつ小分け）をお持ちください。お気に入りのおもちゃやブランケットもあると安心です。ケージ・食器はこちらで用意があります。" },
  { q: "当日予約はできますか？", a: "空きがあれば当日でもお受けしています。WEB予約は翌日以降となりますので、当日はお電話（0460-80-0290）でご相談ください。ただし繁忙期（GW、夏休み、年末年始、紅葉シーズン）は満室になることが多いため、お早めに。" },
  { q: "お預かり中に体調を崩したら？", a: "まず飼い主様へご連絡します。DogHubは車で4分の場所にあるアニマルクリニック仙石原と提携しており、クリニックの診療時間内であればご相談・受診いたします。夜間や診療時間外は、24時間常駐のスタッフとライブカメラで見守りながら、飼い主様と連絡を取り合って対応します。24時間いつでも受診できる体制ではございませんので、あらかじめご了承ください。" },
  { q: "カフェだけの利用もできますか？", a: "もちろんです。ペットホテルを使わなくても、カフェのご利用だけでも歓迎です（予約不要）。おむすび＆スープをご提供する土日祝は店内で愛犬とお過ごしいただけ、併設ドッグランもご利用いただけます。平日はお飲み物のテイクアウト販売のみで、店内でのご飲食とドッグランのご利用はできません。" },
  { q: "営業時間は？", a: "ペットホテルは9:00〜17:00（早朝7時からの預かりも対応）。カフェのおむすび＆スープは土日祝の11:00〜17:00、それ以外の営業日はお飲み物のテイクアウト販売のみ（9:00〜17:00）です。定休日は水曜・木曜です。" },
];
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-[#3C200F] mb-4" style={{ fontSize: "16px", fontWeight: 400, lineHeight: "2" }}>
                箱根旅行中のペット預かりはもちろん、カフェだけのご利用も歓迎しています（店内のご飲食とドッグランは土日祝のみ）。
              </p>
