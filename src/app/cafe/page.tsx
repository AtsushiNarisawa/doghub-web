...
export const metadata: Metadata = {
  openGraph: {
    ...
    description: "箱根で犬連れランチならDogHubのドッグカフェへ。おむすびとスープを愛犬と店内で楽しめるのは土日祝11〜17時。ご利用のお客様は併設ドッグランも。平日はお飲み物のテイクアウト販売のみです。予約不要・頭数制限なし。",
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-start">
              <div>
                ...
                <p className="text-[#3C200F] mb-4" style={{ fontSize: "16px", fontWeight: 400, lineHeight: "2" }}>
                  ...
                  おむすび＆スープをご用意する土日祝は、わんちゃんと一緒に召し上がれる室内イートインスペースもご利用いただけます。
                  平日はお飲み物のテイクアウト販売のみとなり、店内でのご飲食はご遠慮いただいております。
                </p>
                <p className="text-[#3C200F] mb-6" style={{ fontSize: "16px", fontWeight: 400, lineHeight: "2" }}>
                  ...
                  ドッグランのご利用は、おむすび＆スープをご提供する土日祝にカフェをご利用のお客様に限らせていただいております。
                </p>
                <div className="bg-[#F7F7F7] p-6 mb-6">
                  ...
                  <p className="text-[#3C200F] mb-1" style={{ fontSize: "16px", fontWeight: 400 }}>お飲み物のテイクアウト：平日 午前9時〜午後5時</p>
                  ...
                  <p className="text-[#8F7B65]" style={{ fontSize: "14px", fontWeight: 400, lineHeight: "1.8" }}>
                    店内のイートインスペースと併設ドッグランをご利用いただけるのは、<br />
                    おむすび＆スープをご提供する土日祝のみです。<br />
                    平日はお飲み物のテイクアウト販売のみとなります。<br />
        ...
        <section className="py-16 px-6 bg-white border-t border-[#E5DDD8]">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { title: "室内で犬と一緒に食事OK（土日祝）", body: "おむすび＆スープをご提供する土日祝は、店内のイートインスペースでリード着用のうえ愛犬とご一緒にお食事いただけます。平日はお飲み物のテイクアウト販売のみです。" },
                { title: "予約不要・頭数制限なし", body: "カフェのご利用に予約は不要です。わんちゃんの頭数制限もございません。お散歩やドライブの途中にお気軽にお立ち寄りください。" },
                { title: "食後はドッグランへ（土日祝）", body: "土日祝にカフェをご利用のお客様は、併設の専用ドッグランもお使いいただけます。飼い主様同伴でリードなしOK。ランチの後にわんちゃんを思いっきり遊ばせてあげられます。" },
              ].map((item) => (
            ...
            <div className="mt-8 bg-[#F7F7F7] p-6">
              ...
              <p className="text-[#8F7B65]" style={{ fontSize: "14px", fontWeight: 400, lineHeight: "1.8" }}>
                お預かり中のお迎え前後にカフェをご利用いただくこともできます。おむすびとスープをご用意している土日祝は、ゴルフや観光の帰りに一息つきながら、愛犬との再会をお楽しみください。
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <script
              ...
              dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                "@type": "FAQPage",
                mainEntity: [
                  { "@type": "Question", name: "箱根で犬と一緒に室内で食事できるお店はありますか？", acceptedAnswer: { "@type": "Answer", text: "DogHub箱根仙石原のOMUSUBI & SOUP CAFEでは、おむすび＆スープをご提供する土日祝の11:00〜17:00に、室内のイートインスペースで犬と一緒にお食事いただけます。リード着用でご利用ください。予約不要、犬の頭数制限なし。平日（金・月・火）はお飲み物のテイクアウト販売のみで、店内でのご飲食はできません。" }},
                  { "@type": "Question", name: "テイクアウトはできますか？", acceptedAnswer: { "@type": "Answer", text: "はい、テイクアウトもOKです。土日祝はおむすび＆スープをお持ち帰りいただけるほか、天気の良い日は併設ドッグランの横のベンチで召し上がるのもおすすめです。平日はお飲み物のテイクアウト販売のみとなります。" }},
                  { "@type": "Question", name: "カフェだけの利用でもドッグランを使えますか？", acceptedAnswer: { "@type": "Answer", text: "おむすび＆スープをご提供する土日祝にカフェをご利用いただいた場合に、併設の専用ドッグランもご利用いただけます（飼い主様同伴でリードなしOK）。平日はお飲み物のテイクアウト販売のみのため、ドッグランのご利用はできません。" }},
            ...
            <div className="space-y-4">
              {[
                { q: "箱根で犬と一緒に室内で食事できるお店はありますか？", a: "DogHub箱根仙石原のOMUSUBI & SOUP CAFEでは、おむすび＆スープをご提供する土日祝の11:00〜17:00に、室内のイートインスペースで犬と一緒にお食事いただけます。リード着用でご利用ください。予約不要、犬の頭数制限なし。平日（金・月・火）はお飲み物のテイクアウト販売のみで、店内でのご飲食はできません。" },
                { q: "テイクアウトはできますか？", a: "はい、テイクアウトもOKです。土日祝はおむすび＆スープをお持ち帰りいただけるほか、天気の良い日は併設ドッグランの横のベンチで召し上がるのもおすすめです。平日はお飲み物のテイクアウト販売のみとなります。" },
                { q: "カフェだけの利用でもドッグランを使えますか？", a: "おむすび＆スープをご提供する土日祝にカフェをご利用いただいた場合に、併設の専用ドッグランもご利用いただけます（飼い主様同伴でリードなしOK）。平日はお飲み物のテイクアウト販売のみのため、ドッグランのご利用はできません。" },
