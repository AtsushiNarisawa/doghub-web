...
export const FAQ_RULES: FaqRule[] = [
  ...
  {
    // 体調・急病時の対応（2026-08-09新設。アニマルクリニック仙石原との提携開始にあわせて追加）。
    // ⚠️ 「受入確認」より後に置く＝"持病があって体調が心配" は可否判断が先なので人へ回す。
    // ⚠️ クリニックは24時間対応ではない（CEO確認2026-08-09）。「診療時間内であれば」を必ず入れる。
    //    先方の診療時間はここに書かない（変更に追随できないため）。
    category: "体調・急病時の対応",
    keywords: ["体調", "具合", "動物病院", "獣医", "急病", "ケガ", "怪我", "けが"],
    reply: [
      {
        type: "text",
        text:
          "お預かり中の体調についてです🏥\n" +
          "24時間スタッフが常駐し、ライブカメラとあわせて見守っています。異変があった場合は、まず飼い主様へご連絡します。\n" +
          "車で4分のアニマルクリニック仙石原と提携しており、クリニックの診療時間内であればご相談・受診いたします（24時間いつでも受診できる体制ではございません）。\n" +
          `お急ぎのご相談はお電話（${TEL}）へ。`,
      },
    ],
  },
    ...
    reply: [
      {
        ...
        text:
          "到着時間の変更・遅刻についてです🕐\n" +
          "・あらかじめ分かっている到着時間の変更は、ご予約時にお送りした「変更・キャンセルはこちら」のリンク（このLINE、または予約確認メール）から承っております。\n" +
    ...
    reply: [
      {
        ...
        text:
          ...
          "・到着予定時間や備考の変更、キャンセルは、ご予約時にお送りした「変更・キャンセルはこちら」のリンク（このLINE、または予約確認メール）から行えます\n" +
          `・当日のキャンセルやお急ぎのご連絡は、お電話（${TEL}）をお願いいたします（LINEはスタッフが確認するまでお時間をいただくことがあります）`,
      },
    ],
  },
  {
    ...
    reply: [
      {
        ...
        text:
          ...
          "・カフェ（おむすび＆スープ・店内可） 土日祝 11:00〜17:00\n" +
          "・お飲み物のテイクアウト販売のみ 平日 9:00〜17:00\n" +
          "・定休日 水曜・木曜\n" +
