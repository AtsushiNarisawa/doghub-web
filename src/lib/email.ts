...
function winbackBodyText(template: WinbackTemplate): string[] {
  if (template === "discovery") {
    return [
      ...
      "8月のお盆や9月の連休は例年混み合う時期です。お盆や連休のお預かりも承っておりますので、ご予定が決まりましたら、お早めにご予約いただけますと安心です。",
      "スタッフ一同、またお会いできるのを楽しみにしております。",
    ];
  }
  return [
    "DogHub箱根仙石原です。以前はわんちゃんとご一緒にご利用いただきありがとうございました。",
    "箱根はこれから夏本番。標高の高い仙石原は避暑地として過ごしやすく、わんちゃん連れの旅行にちょうど良い季節です。8月のお盆や9月の連休は例年混み合う時期ですので、ご予定が決まりましたら、お早めにご予約いただけますと安心です。",
